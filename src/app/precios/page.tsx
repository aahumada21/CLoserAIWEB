...
const planes = [
  ...
  },
  {
    ...
    incluye: [
      ...
      { texto: "Varios trabajadores registrados en el sistema", pronto: false },
      { texto: "Cada trabajador con sus propios servicios disponibles", pronto: false },
      { texto: "Cada trabajador con su propio horario de atención", pronto: false },
      { texto: "El bot asigna la cita al trabajador correcto según disponibilidad", pronto: false },
      { texto: "Cotización automática de servicios y precios por trabajador", pronto: false },
      { texto: "Hasta 3 números / líneas de WhatsApp independientes", pronto: false },
  ...
  },
  {
    ...
    precio: "$100.000",
    descripcion:
      "Todo lo del Plus, más un link propio para que tus clientes agenden solos desde tu sitio web o redes sociales.",
    tag: "Recomendado",
    destacado: true,
    incluye: [
      { texto: "Todo lo del plan Plus (trabajadores, horarios y precios por persona)", pronto: false },
      { texto: "Link de agendamiento web — el cliente reserva desde tu Instagram, sitio o cualquier lugar", pronto: false },
      { texto: "El bot y el link web comparten la misma disponibilidad en tiempo real", pronto: false },
      { texto: "Pagos online al momento de reservar (el cliente paga al agendar)", pronto: true },
      { texto: "Trabajadores / líneas ilimitados", pronto: false },
